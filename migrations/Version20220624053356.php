 ...
 */
final class Version20220624053356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD brandid_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D34A04AD506E4F3 ON product');
        $this->addSql('ALTER TABLE product DROP brandid_id');
    }
}
